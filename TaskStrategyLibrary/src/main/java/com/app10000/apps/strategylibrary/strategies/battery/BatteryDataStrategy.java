...
public class BatteryDataStrategy extends ProtocolStrategy
{
    ...
    public BatteryDataStrategy(byte address, @MachineVersion int machineVersion)
    {
    ...
    protected void execute_can(CanDeviceIoAction deviceIoAction)
    {
        switch (machineVersion)
        {
            case MachineVersion.SC_6:
                break;
            default:
                exec_default_can(deviceIoAction);
                break;
        }
    }

    private void exec_default_can(CanDeviceIoAction deviceIoAction)
    {
